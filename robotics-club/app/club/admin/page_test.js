...
const AdminDashboard = () => {
    ...
    // Simple test admin menu without Link first
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                {adminMenuItems.map((item, index) => (
                                    <div 
                                        ...
                                        className="bg-[rgb(13,13,13)] border border-[rgb(29,29,29)] rounded-lg p-6 hover:border-[var(--primary)] transition-all cursor-pointer group"
                                    >
